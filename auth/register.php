...
<html lang="en">
	<head>
		...
		<title>Register | Spark Motor</title>
			...
			<div class="row align-items-center min-vh-100">
				...
				if(isset($_GET['message'])){
					...
					elseif($_GET['message'] == 3){
						...
						Photo extensions cannot be used !
						</div>
						";
					}
				}
					...
					<div class="card border-0 shadow-sm">
						<div class="row g-0 justify-content-evenly">
							<div class="col-lg-6 d-none d-lg-block">
								<img src="../public/assets/img/illustration.svg" alt="..." class="img-fluid imgBox mt-lg-5" />
							</div>
								...
								<div class="card-body">
									...
									<form action="./commands/register-user.php" method="POST" enctype="multipart/form-data">
										<div class="mb-2">
											...
											<input required type="text" name="nama" class="form-control" id="exampleInpuName" placeholder="Your Name" />
										</div>
										<div class="mb-2">
											<label for="exampleInputAddress" class="form-label">Address</label>
											<input required type="text" name="alamat" class="form-control" id="exampleInputAddress" placeholder="Address Line" />
										</div>
										<div class="mb-2">
										...
										<button name="submit" type="submit" class="btn btn-primary float-end me-lg-2 py-2">Register</button>
									</form>
								</div>
							</div>
						</div>
